...
public class RobotMap {
    ...
    public static class Component {
        ...
        public static CANTalonFX rightWheelATalon;
        public static CANTalonFX rightWheelBTalon;
        public static AHRS navx;
        public static CANTalonFX leftWheelATalon;
        public static CANTalonFX leftWheelBTalon;
    ...
    public RobotMap() {
        ...
        /* Drive Train */
        // TalonFX
        Component.rightWheelATalon = new CANTalonFX(Port.CANMotor.RIGHT_DRIVE_A, InvertType.None);
        Component.rightWheelBTalon = new CANTalonFX(Port.CANMotor.RIGHT_DRIVE_B, InvertType.FollowMaster);
        Component.leftWheelATalon  = new CANTalonFX(Port.CANMotor.LEFT_DRIVE_A, InvertType.InvertMotorOutput);
        Component.leftWheelBTalon  = new CANTalonFX(Port.CANMotor.LEFT_DRIVE_B, InvertType.FollowMaster);

        // components
        TalonMotorSubsystem leftDriveMotors  = new TalonMotorSubsystem("left drive motors",  NeutralMode.Brake, 0, Component.leftWheelATalon,  Component.leftWheelBTalon);
        TalonMotorSubsystem rightDriveMotors = new TalonMotorSubsystem("right drive motors", NeutralMode.Brake, 0, Component.rightWheelATalon, Component.rightWheelBTalon);
